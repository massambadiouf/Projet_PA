!(function (n) {
    ...
    function w(t) {
        if (!$t.__browser) {
            ...
            (e.barWidth = a[0].offsetWidth - a[0].clientWidth),
                ...
                (e.bScrollbarLeft = 1 !== Math.round(o.offset().left)),
                (e.bBounding = !!n[0].getBoundingClientRect().width),
                n.remove();
        }
        L.extend(t.oBrowser, $t.__browser),
            (t.oScroll.iBarWidth = $t.__browser.barWidth);
    }
    ...
    function _(t, e) {
        ...
        t.aoColumns.push(n),
            ((n = t.aoPreSearchCols)[a] = L.extend(
                {},
                $t.models.oSearch,
                n[a]
            )),
    ...
    function T(t, e, n) {
        ...
        (e._bAttrSrc =
            L.isPlainObject(l) && (n(l.sort) || n(l.type) || n(l.filter))),
            (e._setter = null),
            ...
            t.oFeatures.bSort ||
                ((e.bSortable = !1), o.addClass(a.sSortableNone)),
            (t = -1 !== L.inArray("asc", e.asSorting)),
            (n = -1 !== L.inArray("desc", e.asSorting)),
            e.bSortable && (t || n)
                ? t && !n
    ...
    function l(t) {
        ...
        for (e = 0, n = c.length; e < n; e++)
            if (((u = []), !(i = c[e]).sType && i._sManualType))
                ...
                for (a = 0, o = f.length; a < o; a++) {
                    for (
                        r = 0, l = d.length;
                        r < l &&
                        (u[r] === R && (u[r] = B(t, r, e, "type")),
                        (s = f[a](u[r], t)) || a === f.length - 1) &&
                        "html" !== s;
                        r++
                    );
                    if (s) {
            ...
            for (o = e.length - 1; 0 <= o; o--) {
                ...
                for (L.isArray(d) || (d = [d]), r = 0, l = d.length; r < l; r++)
                    if ("number" == typeof d[r] && 0 <= d[r]) {
                        ...
                        a(d[r], u);
                    } else if ("number" == typeof d[r] && d[r] < 0)
                        a(c.length + d[r], u);
                    else if ("string" == typeof d[r])
                        for (i = 0, s = c.length; i < s; i++)
                            ("_all" == d[r] || L(c[i].nTh).hasClass(d[r])) &&
                                a(i, u);
            }
        if (n) for (o = 0, t = n.length; o < t; o++) a(o, n[o]);
    }
    function A(t, e, n, a) {
        ...
        return (
            ...
            (e = t.rowIdFn(e)) !== R && (t.aIds[e] = r),
            (n || !t.oFeatures.bDeferRender) && m(t, o, n, a),
            o
        );
    }
    function k(n, t) {
    ...
    function B(t, e, n, a) {
        var o = t.iDraw,
            ...
            l = t.aoData[e]._aData,
            i = r.sDefaultContent,
            s = r.fnGetData(l, a, { settings: t, row: e, col: n });
        if (s === R)
            return (
                t.iDrawError != o &&
                    null === i &&
                ...
                for (var o, r, l = 0, i = n.length - 1; l < i; l++) {
                    if (((o = n[l].match(ce)), (r = n[l].match(de)), o)) {
                        if (
                            ((n[l] = n[l].replace(ce, "")),
                            (t[n[l]] = []),
                            (a = n.slice()).splice(0, l + 1),
                            (o = a.join(".")),
                            L.isArray(e))
                        )
                            for (r = 0, i = e.length; r < i; r++)
                                s((a = {}), e[r], o), t[n[l]].push(a);
                        else t[n[l]] = e;
                        return;
                    }
                    r && ((n[l] = n[l].replace(de, "")), (t = t[n[l]](e))),
    ...
    function d(t, e, n) {
        for (var a = -1, o = 0, r = t.length; o < r; o++)
            t[o] == e ? (a = o) : t[o] > e && t[o]--;
    ...
    function o(n, a, t, e) {
        ...
        if ("dom" !== t && ((t && "auto" !== t) || "dom" !== r.src)) {
            ...
            if (i)
                if (e !== R) l(i[e], e);
                else for (t = 0, o = i.length; t < o; t++) l(i[t], t);
    ...
    function s(t, e, n, a) {
            ...
            f =
                ...
                function (t, e) {
                    if ("string" == typeof t) {
                        ...
                        -1 !== n &&
                            ((n = t.substring(n + 1)),
                            h(t)(a, e.getAttribute(n)));
                    }
                }),
            p = function (t) {
                (n !== R && n !== u) ||
                    ((r = c[u]),
                    (l = L.trim(t.innerHTML)),
                    r && r._bAttrSrc
                        ? (h(r.mData._)(a, l),
                          f(r.mData.sort, t),
                          f(r.mData.type, t),
        ...
        if (s)
            for (; s; )
                ("TD" != (o = s.nodeName.toUpperCase()) && "TH" != o) ||
                    (p(s), i.push(s)),
                    (s = s.nextSibling);
        else for (s = 0, o = (i = e.anCells).length; s < o; s++) p(i[s]);
        return (
        ...
        if (null === u.nTr) {
            for (
                ...
                (l = t.aoColumns[i]),
                    ((r = n
                        ? a[i]
                        : y.createElement(l.sCellType))._DT_CellIndex = {
                        row: e,
                        column: i,
                    }),
                    d.push(r),
                    (n && !l.mRender && l.mData === i) ||
                        (L.isPlainObject(l.mData) &&
                            l.mData._ === i + ".display") ||
                        (r.innerHTML = B(t, e, i, "display")),
                    l.sClass && (r.className += " " + l.sClass),
                    l.bVisible && !n
                        ? o.appendChild(r)
                        : !l.bVisible && n && r.parentNode.removeChild(r),
                    l.fnCreatedCell &&
        ...
        if (n) {
            ...
            o && (n.id = o),
                a.DT_RowClass &&
                    ...
                    (e.__rowc = e.__rowc ? se(e.__rowc.concat(o)) : o),
                    L(n)
                        .removeClass(e.__rowc.join(" "))
                        .addClass(a.DT_RowClass)),
                a.DT_RowAttr && L(n).attr(a.DT_RowAttr),
                a.DT_RowData && L(n).data(a.DT_RowData);
        }
    }
    function b(t) {
        var e,
            ...
            u = t.oClasses,
            c = t.aoColumns;
        for (s && (o = L("<tr/>").appendTo(l)), e = 0, n = c.length; e < n; e++)
            (r = c[e]),
                (a = L(r.nTh).addClass(r.sClass)),
                s && a.appendTo(o),
                t.oFeatures.bSort &&
                    (a.addClass(r.sSortingClass),
                    !1 !== r.bSortable &&
                        (a
                            .attr("tabindex", t.iTabIndex)
                            .attr("aria-controls", t.sTableId),
                        _t(t, r.nTh, e))),
                r.sTitle != a[0].innerHTML && a.html(r.sTitle),
                Ht(t, "header")(t, a, r, u);
        if (
            (s && W(t.aoHeader, l),
            L(l).find(">tr").attr("role", "row"),
            L(l).find(">tr>th, >tr>td").addClass(u.sHeaderTH),
            L(i).find(">tr>th, >tr>td").addClass(u.sFooterTH),
            null !== i)
        )
            for (e = 0, n = (t = t.aoFooter[0]).length; e < n; e++)
                ((r = c[e]).nTf = t[e].cell),
                    r.sClass && L(r.nTf).addClass(r.sClass);
    }
    function O(t, e, n) {
        var a,
            o,
        ...
        if (e) {
            for (n === R && (n = !1), a = 0, o = e.length; a < o; a++) {
                for (
                    i[a] = e[a].slice(), i[a].nTr = e[a].nTr, r = u - 1;
                    0 <= r;
                    r--
                )
                    !t.aoColumns[r].bVisible && !n && i[a].splice(r, 1);
                s.push([]);
            }
            for (a = 0, o = i.length; a < o; a++) {
                ...
                for (r = 0, e = i[a].length; r < e; r++)
                    if (((l = u = 1), s[a][r] === R)) {
                        for (
                            t.appendChild(i[a][r].cell), s[a][r] = 1;
                            i[a + u] !== R && i[a][r].cell == i[a + u][r].cell;
    ...
    function H(t) {
        ...
        if (-1 !== L.inArray(!1, e)) ft(t, !1);
            ...
            if (0 !== s.length)
                for (r = i ? t.aoData.length : u, i = i ? 0 : l; i < r; i++) {
                    ...
                    if ((null === d.nTr && m(t, c), (c = d.nTr), 0 !== o)) {
                        var f = a[n % o];
                        d._sRowStripe != f &&
                            (L(c).removeClass(d._sRowStripe).addClass(f),
                            (d._sRowStripe = f));
                    }
                    jt(t, "aoRowCallback", null, [c, d._aData, n, i]),
                        e.push(c),
                        n++;
                }
            else
            ...
            jt(t, "aoHeaderCallback", "header", [
                ...
                (a = L(t.nTBody)).children().detach(),
                a.append(L(e)),
                jt(t, "aoDrawCallback", "draw", [t]),
                (t.bSorted = !1),
                (t.bFiltered = !1),
                (t.bDrawing = !1);
        }
    ...
    function M(t) {
        ...
        for (
            var r, l, i, s, u, c, d = t.sDom.split(""), f = 0;
            f < d.length;
            f++
        ) {
            if (((r = null), "<" == (l = d[f]))) {
    ...
    function q(a, t, e) {
        if ((jt(a, "aoServerParams", "serverParams", [t]), t && L.isArray(t))) {
            ...
            L.each(t, function (t, e) {
                ...
                n
                    ? ((n = n[0]), o[n] || (o[n] = []), o[n].push(e.value))
                    : (o[e.name] = e.value);
            }),
                (t = o);
        }
        ...
        (u = {
            ...
            error: function (t, e) {
                var n = jt(a, null, "xhr", [a, null, a.jqXHR]);
                -1 === L.inArray(!0, n) &&
                    ("parsererror" == e
                        ? Bt(a, 0, "Invalid JSON response", 1)
                        : 4 === t.readyState && Bt(a, 0, "Ajax error", 7)),
                    ft(a, !1);
            },
        }),
            (a.oAjaxData = t),
            jt(a, null, "preXhr", [a, t]),
            a.fnServerData
                ? a.fnServerData.call(
                      i,
                      a.sAjaxSource,
                ...
                ? (a.jqXHR = L.ajax(L.extend(u, { url: l || a.sAjaxSource })))
                : L.isFunction(l)
                ? (a.jqXHR = l.call(i, t, s, a))
                : ((a.jqXHR = L.ajax(L.extend(u, l))), (l.data = n));
    }
    function z(e) {
        return (
            !e.bAjaxDataGet ||
    ...
    function t(t) {
        var e,
            ...
            d = St(t);
        (e = t._iDisplayStart),
            (n = !1 !== i.bPaginate ? t._iDisplayLength : -1);
        var f = function (t, e) {
            c.push({ name: t, value: e });
        };
        f("sEcho", t.iDraw),
            f("iColumns", l),
            f("sColumns", oe(r, "sName").join(",")),
            f("iDisplayStart", e),
            f("iDisplayLength", n);
        var p = {
            draw: t.iDraw,
        ...
        for (e = 0; e < l; e++)
            (a = r[e]),
                ...
                f("mDataProp_" + e, n),
                i.bFilter &&
                    (f("sSearch_" + e, o.sSearch),
                    f("bRegex_" + e, o.bRegex),
                    f("bSearchable_" + e, a.bSearchable)),
                i.bSort && f("bSortable_" + e, a.bSortable);
        return (
            i.bFilter && (f("sSearch", s.sSearch), f("bRegex", s.bRegex)),
            i.bSort &&
    ...
    function $(t, e) {
        var n =
            L.isPlainObject(t.ajax) && t.ajax.dataSrc !== R
                ? t.ajax.dataSrc
                : t.sAjaxDataProp;
    ...
    function X(n) {
        ...
        return (
            L(n.nTable).on("search.dt.DT", function (t, e) {
                if (n === e)
                    try {
        ...
        if ((l(t), "ssp" != Et(t))) {
            for (
                Y(
                    ...
                    e.sSearch,
                    n,
                    e.bEscapeRegex !== R ? !e.bEscapeRegex : e.bRegex,
                    e.bSmart,
                    e.bCaseInsensitive
                ),
                    r(e),
                ...
                K(
                    ...
                    o[e].sSearch,
                    e,
                    o[e].bEscapeRegex !== R ? !o[e].bEscapeRegex : o[e].bRegex,
                    o[e].bSmart,
    ...
    function G(t) {
        for (
            var e, n, a = $t.ext.search, o = t.aiDisplay, r = 0, l = a.length;
            r < l;
            r++
        ) {
            for (var i = [], s = 0, u = o.length; s < u; s++)
                (n = o[s]),
                    (e = t.aoData[n]),
                    a[r](t, e._aFilterData, n, e._aData, s) && i.push(n);
    ...
    function K(t, e, n, a, o, r) {
        if ("" !== e) {
            var l = [],
                i = t.aiDisplay;
            for (a = Z(e, a, o, r), o = 0; o < i.length; o++)
                (e = t.aoData[i[o]]._aFilterData[n]), a.test(e) && l.push(i[o]);
            t.aiDisplay = l;
        }
    }
    function Y(t, e, n, a, o, r) {
        ...
        var l,
            i = t.aiDisplayMaster;
        o = [];
        if ((0 !== $t.ext.search.length && (n = !0), (l = Q(t)), e.length <= 0))
            t.aiDisplay = i.slice();
        else {
            for (
                (l ||
                ...
                for (l = [], a = 0, r = u.length; a < r; a++)
                    (e = u[a]).bSearchable
                        ...
                        i.indexOf &&
                            -1 !== i.indexOf("&") &&
                            ((pe.innerHTML = i),
                            (i = he ? pe.textContent : pe.innerText)),
    ...
    function at(t) {
        ...
        if (0 !== e.length) {
            ...
            l !== r && (i += " " + n.sInfoFiltered),
                (i = ot(t, (i += n.sInfoPostFix))),
                null !== (n = n.fnInfoCallback) &&
                    (i = n.call(t.oInstance, t, a, o, r, l, i)),
                L(e).html(i);
        }
    }
    function ot(t, e) {
        ...
        return e
            ...
            .replace(/_PAGE_/g, n.call(t, l ? 1 : Math.ceil(a / o)))
            .replace(/_PAGES_/g, n.call(t, l ? 1 : Math.ceil(r / o)));
    }
    function rt(n) {
        var a,
            t,
            e,
            o = n.iInitDisplayStart,
            r = n.aoColumns;
        t = n.oFeatures;
        ...
        if (n.bInitialised) {
            for (
                ...
                (e = r[a]).sWidth && (e.nTh.style.width = xt(e.sWidth));
            jt(n, null, "preInit", [n]),
                E(n),
                ("ssp" != (r = Et(n)) || l) &&
                    ("ajax" == r
    ...
    function lt(t, e) {
        (t._bInitComplete = !0),
            ...
            jt(t, null, "plugin-init", [t, e]),
            jt(t, "aoInitComplete", "init", [t, e]);
    }
    function it(t, e) {
        var n = parseInt(e, 10);
    ...
    function st(a) {
        for (
            ...
            r[0][l] = new Option(
                "number" == typeof n[l] ? a.fnFormatNumber(n[l]) : n[l],
                o[l]
            );
        ...
        return (
            ...
            s
                .children()
                .append(
                    a.oLanguage.sLengthMenu.replace("_MENU_", r[0].outerHTML)
                ),
            L("select", s)
                        ...
                        if (i) {
                            var e,
                                ...
                                r =
                                    ...
                                    (o = l(n, a)),
                                    0);
                            for (e = u.p.length; r < e; r++)
                                Ht(t, "pageButton")(t, u.p[r], r, o, n, a);
                        } else l.fnUpdate(t, s);
                    },
                    sName: "pagination",
                })),
    ...
    function ct(t, e, n) {
        ...
        return (
            0 === r || -1 === o
                ...
                ? a + o < r && (a += o)
                : "last" == e
                ? (a = Math.floor((r - 1) / o) * o)
                : Bt(t, 0, "Unknown paging action: " + e, 6),
            (e = t._iDisplayStart !== a),
            (t._iDisplayStart = a),
            e && (jt(t, null, "page", [t]), n && H(t)),
            e
        );
    }
    function dt(t) {
    ...
    function pt(t) {
        ...
        var n = e.sX,
            ...
            u = c.children("tfoot");
        u.length || (u = null),
            (i = L("<div/>", { class: o.sScrollWrapper })
                .append(
                    L("<div/>", { class: o.sScrollHead })
                        .css({
                            overflow: "hidden",
                            position: "relative",
                            border: 0,
                        ...
                        .append(
                            L("<div/>", { class: o.sScrollHeadInner })
                                .css({
            ...
            u &&
                i.append(
                    L("<div/>", { class: o.sScrollFoot })
                        ...
                        .append(
                            L("<div/>", { class: o.sScrollFootInner }).append(
                                s
                                    .removeAttr("id")
                                    .css("margin-left", 0)
        ...
        return (
            n &&
                L(o).on("scroll.DT", function () {
                    var t = this.scrollLeft;
                    (d.scrollLeft = t), u && (f.scrollLeft = t);
                }),
            L(o).css(a && e.bCollapse ? "max-height" : "height", a),
            (t.nScrollHead = d),
            (t.nScrollBody = o),
            (t.nScrollFoot = f),
    ...
    function ht(n) {
        ...
        (e = h.scrollHeight > h.clientHeight),
            n.scrollBarVis !== e && n.scrollBarVis !== R
                ? ((n.scrollBarVis = e), P(n))
                : ((n.scrollBarVis = e),
                  x.children("thead, tfoot").remove(),
                  D &&
                      ((a = D.clone().prependTo(x)),
                      (t = D.find("tr")),
                      (a = a.find("tr"))),
                  (o = v.clone().prependTo(x)),
                  (v = v.find("tr")),
                  (e = o.find("tr")),
                  o.find("th, td").removeAttr("tabindex"),
                  l || ((b.width = "100%"), (c[0].style.width = "100%")),
                  L.each(U(n, o), function (t, e) {
                  ...
                  "" === l
                      ? ((I.width = "100%"),
                        _ &&
                            (x.find("tbody").height() > h.offsetHeight ||
                                "scroll" == m.css("overflow-y")) &&
                            (I.width = xt(x.outerWidth() - u)),
                        (c = x.outerWidth()))
                      : "" !== i && ((I.width = xt(i)), (c = x.outerWidth())),
                  mt(B, e),
                  mt(function (t) {
                  ...
                  x.outerWidth() < c
                      ? ((t =
                        ...
                        _ &&
                            ...
                            (I.width = xt(t - u)),
                        ("" === l || "" !== i) &&
                            Bt(n, 1, "Possible column misalignment", 6))
                      : (t = "100%"),
                  (b.width = xt(t)),
                  (d.width = xt(t)),
                  D && (n.nScrollFoot.style.width = xt(t)),
                  !s && _ && (b.height = xt(S.offsetHeight + u)),
                  (l = x.outerWidth()),
                  (p[0].style.width = xt(l)),
                  (f.width = xt(l)),
                  (i =
                      x.height() > h.clientHeight ||
                      "scroll" == m.css("overflow-y")),
                  (f[
                      (s = "padding" + (w.bScrollbarLeft ? "Left" : "Right"))
                  ] = i ? u + "px" : "0px"),
                  D &&
                      ((y[0].style.width = xt(l)),
                      (g[0].style.width = xt(l)),
                      (g[0].style[s] = i ? u + "px" : "0px")),
    ...
    function mt(t, e, n) {
        for (var a, o, r = 0, l = 0, i = e.length; l < i; ) {
            for (a = e[l].firstChild, o = n ? n[l].firstChild : null; a; )
                1 === a.nodeType && (n ? t(a, o, r) : t(a, r), r++),
                    (a = a.nextSibling),
    ...
    function bt(t) {
        var e,
            ...
            m = h.bScrollOversize;
        for (
            (e = a.style.width) && -1 !== e.indexOf("%") && (d = e), e = 0;
            e < u.length;
            e++
        )
            null !== (n = o[u[e]]).sWidth &&
                ((n.sWidth = gt(n.sWidthOrig, f)), (p = !0));
        if (m || (!p && !l && !r && s == v(t) && s == c.length))
            for (e = 0; e < s; e++)
                null !== (u = N(t, e)) && (o[u].sWidth = xt(c.eq(e).width()));
        else {
            (s = L(a).clone().css("visibility", "hidden").removeAttr("id"))
                .find("tbody tr")
                .remove();
            var b = L("<tr/>").appendTo(s.find("tbody"));
            for (
                s.find("thead, tfoot").remove(),
                    s.append(L(t.nTHead).clone()).append(L(t.nTFoot).clone()),
    ...
    function vt(t, e) {
        for (var n, a = -1, o = -1, r = 0, l = t.aoData.length; r < l; r++)
            (n = (n = (n = B(t, r, e, "display") + "").replace(me, "")).replace(
                /&nbsp;/g,
                " "
            )).length > a && ((a = n.length), (o = r));
        return o;
    }
    function xt(t) {
        return null === t
    ...
    function St(t) {
        ...
        for (
            ...
            for (e = 0, n = (a = s[(l = u[t][0])].aDataSort).length; e < n; e++)
                (r = s[(o = a[e])].sType || "string"),
                    u[t]._idx === R &&
                        (u[t]._idx = L.inArray(u[t][1], s[o].asSorting)),
                    i.push({
                        src: l,
                        col: o,
                        dir: u[t][1],
    ...
    function It(t) {
        var e,
            ...
            o = 0,
            r = t.aiDisplayMaster;
        for (l(t), e = 0, n = (u = St(t)).length; e < n; e++)
            (a = u[e]).formatter && o++, Ct(t, a.col);
    ...
    function wt(t, e, n, a) {
        var o = t.aaSorting,
            ...
            l = function (t, e) {
                var n = t._idx;
                return (
                    n === R && (n = L.inArray(t[1], r)),
                    n + 1 < r.length ? n + 1 : e ? null : 0
                );
            };
        "number" == typeof o[0] && (o = t.aaSorting = [o]),
            n && t.oFeatures.bSortMulti
                ? -1 !== (n = L.inArray(e, oe(o, "0")))
                    ? (null === (e = l(o[n], !0)) && 1 === o.length && (e = 0),
                      null === e
                          ? o.splice(n, 1)
                          : ((o[n][1] = r[e]), (o[n]._idx = e)))
                    : (o.push([e, r[0], 0]), (o[o.length - 1]._idx = 0))
                : o.length && o[0][0] == e
                ? ((e = l(o[0])),
                  (o.length = 1),
                  (o[0][1] = r[e]),
                  (o[0]._idx = e))
                : ((o.length = 0), o.push([e, r[0]]), (o[0]._idx = 0)),
            E(t),
    ...
    function Tt(t) {
        ...
        if (l.bSort && l.bSortClasses) {
            for (l = 0, e = a.length; l < e; l++)
                (n = a[l].src),
                    L(oe(t.aoData, "anCells", n)).removeClass(
                        o + (l < 2 ? l + 1 : 6)
                    );
            for (l = 0, e = r.length; l < e; l++)
                (n = r[l].src),
                    L(oe(t.aoData, "anCells", n)).addClass(
                        o + (l < 2 ? l + 1 : 6)
                    );
        }
        t.aLastSort = r;
    ...
    function Ct(t, e) {
        ...
        for (
            var r,
                l = $t.ext.type.order[a.sType + "-pre"],
                i = 0,
                s = t.aoData.length;
            i < s;
            i++
    ...
    function Ft(n) {
        if (n.oFeatures.bStateSave && !n.bDestroying) {
            ...
            jt(n, "aoStateSaveParams", "stateSaveParams", [n, t]),
                (n.oSavedState = t),
            ...
            if (t && t.time) {
                ...
                if (
                    ...
                    !(
                        ...
                        (t.columns && l.length !== t.columns.length)
                    )
                ) {
                    if (
                        ((n.oLoadedState = L.extend(!0, {}, t)),
                        t.start !== R &&
                        ...
                        t.search !== R &&
                            L.extend(n.oPreviousSearch, et(t.search)),
                        t.columns)
                    )
                        for (o = 0, r = t.columns.length; o < r; o++)
                            (e = t.columns[o]).visible !== R &&
                                (l[o].bVisible = e.visible),
                                e.search !== R &&
                                    L.extend(
                                        n.aoPreSearchCols[o],
                                        et(e.search)
    ...
    function Bt(t, e, n, a) {
        if (
            ...
            g.console && console.log && console.log(n);
        else if (
            ((e = (e = $t.ext).sErrMode || e.errMode),
            t && jt(t, null, "error", [t, a, n]),
            "alert" == e)
        )
            alert(n);
        else {
    ...
    function Rt(t, e, n) {
        ...
        for (o in e)
            e.hasOwnProperty(o) &&
                ((a = e[o]),
                L.isPlainObject(a)
                    ? (L.isPlainObject(t[o]) || (t[o] = {}),
                      L.extend(!0, t[o], a))
                    : (t[o] =
                          n && "data" !== o && "aaData" !== o && L.isArray(a)
                              ? a.slice()
                              : a));
        return t;
    }
    ...
    function jt(e, t, n, a) {
        ...
        return (
            t &&
                (o = L.map(e[t].slice().reverse(), function (t) {
                    return t.fn.apply(e.oInstance, a);
                })),
            null !== n &&
                ((t = L.Event(n + ".dt")),
                L(e.nTable).trigger(t, a),
                o.push(t.result)),
            o
        );
    }
    ...
    function Mt(t, e) {
        ...
        return (
            e <= n
                ...
                : (e - 1 - a <= t
                      ? (n = le(e - (n - 2), e))
                      : ((n = le(t - a + 2, t + a - 1)).push("ellipsis"),
                        n.push(e - 1)),
    ...
    function e(e) {
        return function () {
            var t = [kt(this[$t.ext.iApiIndex])].concat(
    ...
    var Ut,
            ...
            (this.$ = function (t, e) {
                ...
                (this.fnAddData = function (t, e) {
                    var n = this.api(!0),
                        a =
                            L.isArray(t) &&
                            (L.isArray(t[0]) || L.isPlainObject(t[0]))
                                ? n.rows.add(t)
                                : n.row.add(t);
                    ...
                    if ("table" != this.nodeName.toLowerCase())
                        ...
                        for (n = i.length; o < n; o++) {
                            ...
                            if (
                                ...
                                if (
                                    a.bDestroy !== R ? a.bDestroy : e.bDestroy
                                ) {
                        ...
                        (c.nTable = this),
                            ...
                            (c.oInit = a),
                            i.push(c),
                            (c.oInstance = 1 === g.length ? g : l.dataTable()),
                            I(a),
                            a.oLanguage && S(a.oLanguage),
                            a.aLengthMenu &&
                                !a.iDisplayLength &&
                                (a.iDisplayLength = L.isArray(a.aLengthMenu[0])
                                    ? a.aLengthMenu[0][0]
                                    : a.aLengthMenu[0]),
                            (a = Rt(L.extend(!0, {}, e), a)),
                            Lt(
                            ...
                            Lt(c.oLanguage, a, "fnInfoCallback"),
                            ...
                            w(c);
                        var d = c.oClasses;
                        L.extend(d, $t.ext.classes, a.oClasses),
                            l.addClass(d.sTable),
                        ...
                        for (o = 0, n = i.length; o < n; o++)
                            _(c, t ? t[o] : null);
                        if (
                            (F(c, a.aoColumnDefs, i, function (t, e) {
                                T(c, t, e);
                            }),
                            p.length)
                        ) {
                        ...
                        t = function () {
                            if (a.aaSorting === R) {
                                ...
                                for (o = 0, n = t.length; o < n; o++)
                                    t[o][1] = c.aoColumns[o].asSorting[0];
                            }
                            Tt(c),
                                m.bSort &&
                            ...
                            if (
                                (0 === e.length &&
                                    (e = L("<thead/>").appendTo(l)),
                                (c.nTHead = e[0]),
                                0 === (e = l.children("tbody")).length &&
                                    (e = L("<tbody/>").appendTo(l)),
                                (c.nTBody = e[0]),
                                0 === (e = l.children("tfoot")).length &&
                                    0 < t.length &&
                                    ("" !== c.oScroll.sX ||
                                        "" !== c.oScroll.sY) &&
                                    (e = L("<tfoot/>").appendTo(l)),
                                0 === e.length || 0 === e.children().length
                                    ? l.addClass(d.sNoFooter)
                                    : 0 < e.length &&
                                      ((c.nTFoot = e[0]),
                                      W(c.aoFooter, c.nTFoot)),
                                a.aaData)
                            )
                                for (o = 0; o < a.aaData.length; o++)
                                    A(c, a.aaData[o]);
                            else
                                (c.bDeferLoading || "dom" == Et(c)) &&
                                    k(c, L(c.nTBody).children("tr"));
                            (c.aiDisplay = c.aiDisplayMaster.slice()),
                                !(c.bInitialised = !0) === r && rt(c);
                        };
                        a.bStateSave
                            ? ((m.bStateSave = !0),
                              Nt(c, "aoDrawCallback", Ft, "state_save"),
                              At(c, a, t))
                            : t();
                    }
                }),
        ...
        oe = function (t, e, n) {
            ...
            else for (; o < r; o++) t[o] && a.push(t[o][e]);
            return a;
        },
        re = function (t, e, n, a) {
            var o = [],
                r = 0,
                l = e.length;
            if (a !== R) for (; r < l; r++) t[e[r]][n] && o.push(t[e[r]][n][a]);
            else for (; r < l; r++) o.push(t[e[r]][n]);
            return o;
        },
        le = function (t, e) {
            var n,
        ...
        se = function (t) {
            ...
            t: {
                if (!(t.length < 2))
                    for (
                        var n = (e = t.slice().sort())[0], a = 1, o = e.length;
                        a < o;
                        a++
                    ) {
                        if (e[a] === n) {
            ...
            a = 0;
            t: for (; a < o; a++) {
                for (n = t[a], r = 0; r < l; r++) if (e[r] === n) continue t;
                e.push(n), l++;
            }
            return e;
        };
    ...
    (qt = function (t, e) {
        ...
        if (L.isArray(t)) for (var a = 0, o = t.length; a < o; a++) n(t[a]);
        else n(t);
        (this.context = se(l)),
            e && L.merge(this, e),
        ...
        L.extend(qt.prototype, {
            ...
            iterator: function (t, e, n, a) {
                ...
                for (
                    ...
                    var h = new qt(f[r]);
                    if ("table" === e)
                        (o = n.call(h, f[r], r)) !== R && d.push(o);
                    else if ("columns" === e || "rows" === e)
                        (o = n.call(h, f[r], this[r], r)) !== R && d.push(o);
                    else if (
                        "column" === e ||
                        "column-rows" === e ||
                        "row" === e ||
                        ...
                        for (
                            ...
                            (o = c[i]),
                                (o =
                                    "cell" === e
                                        ? n.call(h, f[r], o.row, o.column, r, i)
                                        : n.call(h, f[r], o, r, i, u)) !== R &&
                                    d.push(o);
                }
                return d.length || a
                    ? (((e = (t = new qt(f, t ? d.concat.apply([], d) : d))
        ...
        (qt.extend = function (t, e, n) {
            if (n.length && e && (e instanceof qt || e.__dt_wrapper)) {
                ...
                for (a = 0, o = n.length; a < o; a++)
                    (e[(r = n[a]).name] =
                        "function" == typeof r.val
                            ? l(t, r.val, r)
                            : L.isPlainObject(r.val)
                            ? {}
                            : r.val),
                        (e[r.name].__dt_wrapper = !0),
                        qt.extend(t, e[r.name], r.propExt);
            }
        }),
        (qt.register = zt = function (t, e) {
            if (L.isArray(t))
                ...
                for (n = 0, a = l.length; n < a; n++) {
                    ...
                    s ||
                        ((s = { name: o, val: {}, methodExt: [], propExt: [] }),
                        i.push(s)),
                        n === a - 1
                            ? (s.val = e)
                            : (i = r ? s.methodExt : s.propExt);
                }
            }
        }),
    ...
    var ve = function (a, o, t) {
        ...
        if ("ssp" == Et(a)) E(a, o);
            ...
            n && 4 !== n.readyState && n.abort(),
                q(a, [], function (t) {
                    i(a);
                    for (var e = 0, n = (t = $(a, t)).length; e < n; e++)
                        A(a, t[e]);
                    E(a, o), ft(a, !1);
                });
        }
    ...
    var xe = function (t, e, n, a, o) {
            ...
            for (
                ...
                for (
                    u = 0,
                        c = (l =
                            e[i] && e[i].split && !e[i].match(/[\[\(:]/)
                                ? e[i].split(",")
                                : [e[i]]).length;
                    u < c;
                    u++
                )
                    (r = n("string" == typeof l[u] ? L.trim(l[u]) : l[u])) &&
                        r.length &&
                        (d = d.concat(r));
        ...
        De = function (t, e) {
            ...
            n = t.aiDisplayMaster;
            var i = e.search;
            if (((a = e.order), (o = e.page), "ssp" == Et(t)))
                return "removed" === i ? [] : le(0, n.length);
            if ("current" == o)
            ...
            function (a) {
                ...
                return xe(
                    ...
                    function (n) {
                        ...
                        if (((t = ie(re(a.aoData, o, "nTr"))), n.nodeName))
                            return n._DT_RowIndex !== R
                                ? [n._DT_RowIndex]
                                : n._DT_CellIndex
                                ? [n._DT_CellIndex.row]
                                : (t = L(n).closest("*[data-dt-row]")).length
                                ? [t.data("dt-row")]
                                : [];
            ...
            return (
                this.iterator("row", function (t, e, n) {
                    ...
                    for (s.splice(e, 1), a = 0, o = s.length; a < o; a++)
                        if (
                            ((i = (r = s[a]).anCells),
                            null !== r.nTr && (r.nTr._DT_RowIndex = a),
                            null !== i)
                        )
                            for (r = 0, l = i.length; r < l; r++)
                                i[r]._DT_CellIndex.row = a;
                    d(t.aiDisplayMaster, e),
                        d(t.aiDisplay, e),
                        d(c[n], e, !1),
                        0 < t._iRecordsDisplay && t._iRecordsDisplay--,
                        Ot(t),
                        (e = t.rowIdFn(u._aData)) !== R && delete t.aIds[e];
                }),
                this.iterator("table", function (t) {
    ...
    zt("row().child()", function (t, e) {
        var n = this.context;
        if (t === R)
            return n.length && this.length ? n[0].aoData[this[0]]._details : R;
                ...
                l = function (t, e) {
                    if (L.isArray(t) || t instanceof L)
                        ...
                        t.nodeName && "tr" === t.nodeName.toLowerCase()
                            ? r.push(t)
                            : ((n = L("<tr><td/></tr>").addClass(e)),
                              (L("td", n).addClass(e).html(t)[0].colSpan = v(
                                  o
                              )),
                              r.push(n[0]));
                };
    ...
    zt("columns()", function (e, n) {
                ...
                return xe(
                    ...
                    function (n) {
                        ...
                        return n.nodeName && n._DT_CellIndex
                            ...
                            ? t
                            : (t = L(n).closest("*[data-dt-column]")).length
                            ? [t.data("dt-column")]
                            : [];
                    },
                    r,
            ...
            return this.iterator(
                ...
                function (t, e, n, a, o) {
                    return re(
                        t.aoData,
                        o,
                        "search" === r ? "_aFilterData" : "_aSortData",
                        e
                    );
                },
                1
                    ...
                    return xe(
                        ...
                        function (t) {
                            ...
                            return L.isPlainObject(t)
                                ...
                                ? e
                                : (u = L(t).closest("*[data-dt-row]")).length
                                ? [
                                      {
                                          row: u.data("dt-row"),
                ...
                e = this.iterator(
                    ...
                    function (t, e) {
                        for (n = [], a = 0, o = s[e].length; a < o; a++)
                            for (r = 0, l = i[e].length; r < l; r++)
                                n.push({ row: s[e][a], column: i[e][r] });
                        return n;
                    },
                    1
                );
            return L.extend(e.selector, { cols: t, rows: m, opts: b }), e;
        }),
        ...
        ($t.isDataTable = $t.fnIsDataTable = function (t) {
            ...
            return (
                t instanceof $t.Api ||
                (L.each($t.settings, function (t, e) {
        ...
        zt("destroy()", function (d) {
            return (
                ...
                this.iterator("table", function (e) {
                    ...
                    (e.bDestroying = !0),
                        jt(e, "aoDestroyCallback", "destroy", [e]),
                        d || new qt(e).columns().visible(!0),
                        u.off(".DT").find(":not(tbody *)").off(".DT"),
                        L(g).off(".DT-" + e.sInstance),
                        o != l.parentNode &&
                            (s.children("thead").detach(), s.append(l)),
                        i &&
                            o != i.parentNode &&
                            (s.children("tfoot").detach(), s.append(i)),
                        (e.aaSorting = []),
                        (e.aaSortingFixed = []),
                        Tt(e),
                        L(c).removeClass(e.asStripeClasses.join(" ")),
                        L("th, td", l).removeClass(
                            a.sSortable +
                                " " +
                                a.sSortableAsc +
                                " " +
                        ...
                        !d &&
                            t &&
                            (t.insertBefore(o, e.nTableReinsertBefore),
                            s
                        ...
                        -1 !== (t = L.inArray(e, $t.settings)) &&
                            $t.settings.splice(t, 1);
                })
            );
        }),
        ...
        zt("i18n()", function (t, e, n) {
            ...
            return (
                (t = j(t)(a.oLanguage)) === R && (t = e),
                n !== R && L.isPlainObject(t) && (t = t[n] !== R ? t[n] : t._),
                t.replace("%d", n)
            );
        }),
        ($t.version = "1.10.16"),
            ...
            header: {
                ...
                jqueryui: function (o, r, l, i) {
                    L("<div/>")
                        ...
                        .append(
                            L("<span/>").addClass(
                                i.sSortIcon + " " + l.sSortingClassJUI
                            )
                        )
                        .appendTo(r),
                        L(o.nTable).on("order.dt.DT", function (t, e, n, a) {
    ...
    return (
        ...
        (((L.fn.dataTable = $t).$ = L).fn.dataTableSettings = $t.settings),
        (L.fn.dataTableExt = $t.ext),
                            ...
                            if (((r = e[n]), v.isArray(r))) y(t, r);
                                ...
                                d &&
                                    ((o = v("<li>", {
                                        ...
                                        .appendTo(t)),
                                    i.oApi._fnBindAction(o, { action: r }, l),
                                    g++);
                            }
                    };
                try {
    ...
    (function (n) {
        ...
        h.extend(d.prototype, {
            ...
            disable: function (t) {
                return (
                    ...
                    h(t.node).addClass(this.c.dom.button.disabled),
                    this
                );
            },
            destroy: function () {
                ...
                for (
                    this.dom.container.remove(),
                        t = 0,
                        e = (n = this.s.dt.settings()[0]).length;
                    t < e;
                    t++
                )
                    if (n.inst === this) {
            ...
            processing: function (t, e) {
                var n = this._nodeToButton(t);
                return e === c
                    ? h(n.node).hasClass("processing")
                    : (h(n.node).toggleClass("processing", e), this);
            },
            remove: function (t) {
                ...
                return (
                    e.conf.destroy &&
                        e.conf.destroy.call(a.button(t), a, h(t), e.conf),
            ...
            text: function (t, e) {
                ...
                return e === c
                    ? l(n.conf.text)
                    : ((n.conf.text = e),
                      a ? r.children(a).html(l(e)) : r.html(l(e)),
                      this);
            },
            ...
            _addKey: function (t) {
                t.key &&
                    (this.s.listenKeys += h.isPlainObject(t.key)
                        ? t.key.key
                        : t.key);
            },
            _draw: function (t, e) {
                        ...
                        if (h.isArray(i)) this._expandButton(t, i, n, a);
                            ...
                            if (s) {
                                if (
                                    ...
                                    (s.collection = h("<" + u.tag + "/>")
                                        .addClass(u.className)
                                        .attr("role", "menu")),
                                        (s.conf._collection = s.collection),
                                        this._expandButton(
                                            s.buttons,
                                            s.conf.buttons,
                                            !0,
            ...
            _buildButton: function (e, t) {
                ...
                if (
                    (t && o.button && (n = o.button),
                    t && o.buttonLiner && (a = o.buttonLiner),
                    e.available && !e.available(r, e))
                )
                    return !1;
                var i = function (t, e, n, a) {
                        a.action.call(e.button(n), t, e, n, a),
                            h(
                                e.table().node()
                ...
                return (
                    "a" === n.tag.toLowerCase() && s.attr("href", "#"),
                    a.tag
                        ? ((o = h("<" + a.tag + "/>")
                              .html(l(e.text))
                              .addClass(a.className)),
                          "a" === a.tag.toLowerCase() && o.attr("href", "#"),
                          s.append(o))
                        : s.html(l(e.text)),
                    !1 === e.enabled && s.addClass(n.disabled),
                    e.className && s.addClass(e.className),
                    e.titleAttr && s.attr("title", l(e.titleAttr)),
                    e.namespace || (e.namespace = ".dt-button-" + u++),
                    (a =
                        (a = this.c.dom.buttonContainer) && a.tag
                            ? h("<" + a.tag + "/>")
                                  .addClass(a.className)
                                  .append(s)
                            : s),
                ...
                var i = function (t) {
                    for (var e = 0, n = t.length; e < n; e++) {
                        ...
                        a.key &&
                            (a.key === r
                                ? h(o).click()
                                : !h.isPlainObject(a.key) ||
                                  a.key.key !== r ||
                                  (a.key.shiftKey && !l.shiftKey) ||
                                  (a.key.altKey && !l.altKey) ||
                                  (a.key.ctrlKey && !l.ctrlKey) ||
                                  ((!a.key.metaKey || l.metaKey) &&
                                      h(o).click())),
                            t[e].buttons.length && i(t[e].buttons);
                    }
                };
                i(this.s.buttons);
            },
            ...
            _resolveExtends: function (n) {
                ...
                for (n = o(n); n && n.extend; ) {
                    ...
                    if (l) {
                        for (
                            n.buttons || (n.buttons = []), t = 0, e = l.length;
                            t < e;
                            t++
                        )
                            n.buttons.push(l[t]);
                    ...
                    l = function (t) {
                        if (h.isArray(t))
                            ...
                            "string" == typeof t
                                ? -1 !== t.indexOf(",")
                                    ? l(t.split(","))
                                    : -1 !== (t = h.inArray(h.trim(t), r)) &&
                                      o.push(a[t].inst)
                                : "number" == typeof t && o.push(a[t].inst);
                    };
                return l(t), o;
            }),
            (d.buttonSelector = function (t, e) {
                for (
                    var l = [],
                        i = function (t, e, n) {
                            for (var a, o, r = 0, l = e.length; r < l; r++)
                                (a = e[r]) &&
                                    ((o = n !== c ? n + r : r + ""),
                                    t.push({
                                        node: a.node,
                        ...
                        s = function (t, e) {
                            ...
                            if (
                                ...
                                for (n = 0, a = o.length; n < a; n++)
                                    l.push({ inst: e, node: o[n].node });
                            else if ("number" == typeof t)
                                l.push({ inst: e, node: e.s.buttons[t].node });
                            else if ("string" == typeof t)
                                if (-1 !== t.indexOf(","))
                                    for (
                                        n = 0, a = (o = t.split(",")).length;
                                        n < a;
                                        n++
                                    )
                                        s(h.trim(o[n]), e);
                                    ...
                                    h(n)
                                        .filter(t)
                                        .each(function () {
                                            l.push({ inst: e, node: this });
                                        });
                            else
                                "object" == typeof t &&
                                    t.nodeName &&
                                    -1 !== (o = h.inArray(t, n)) &&
                                    l.push({ inst: e, node: n[o] });
                        },
                        n = 0,
                        a = t.length;
                    n < a;
            ...
            h.extend(s, {
                collection: {
                    ...
                    action: function (t, n, e, a) {
                        ...
                        var o = h(n.table().container()),
                            r = !1;
                        h("div.dt-button-background").length &&
                            ((r = h(".dt-button-collection").offset()),
                            h("body").trigger("click.dtb-collection")),
                            a._collection
                                .addClass(a.collectionLayout)
                                .css("display", "none")
                                .appendTo("body")
                                .fadeIn(a.fade);
                        var l = a._collection.css("position");
                        r && "absolute" === l
                            ? a._collection.css({ top: r.top, left: r.left })
                            : "absolute" === l
                            ? (a._collection.css({
                              ...
                              (e =
                                  t.top +
                                  e.outerHeight() +
                                  a._collection.outerHeight() -
                                  r),
                              (r = t.top - a._collection.outerHeight()),
                              (r = o.offset().top - r) < e &&
                                  a._collection.css(
                                      "top",
                                      t.top - a._collection.outerHeight() - 5
                                  ),
                              (e = t.left + a._collection.outerWidth()),
                              (o = o.offset().left + o.width()) < e &&
                                  a._collection.css("left", t.left - (e - o)))
                            : ((t = a._collection.height() / 2) >
                                  h(i).height() / 2 && (t = h(i).height() / 2),
                              a._collection.css("marginTop", -1 * t)),
                            a.background &&
                                d.background(!0, a.backgroundClassName, a.fade),
                            setTimeout(function () {
                                h(
                                    ...
                                    h("body").on(
                                        ...
                                        function (t) {
                                            ...
                                            h(t.target)
                                                .parents()
                                                [e]()
                                                .filter(a._collection).length ||
                                                (a._collection.fadeOut(
                                                    a.fade,
                                                    function () {
                            ...
                            a.autoClose &&
                                n.on("buttons-action.b-internal", function () {
                ...
                copy: function (t, e) {
                    return s.copyHtml5
                        ? "copyHtml5"
                        : s.copyFlash && s.copyFlash.available(t, e)
                        ? "copyFlash"
                        : void 0;
                },
                csv: function (t, e) {
                    return s.csvHtml5 && s.csvHtml5.available(t, e)
                        ? "csvHtml5"
                        : s.csvFlash && s.csvFlash.available(t, e)
                        ? "csvFlash"
                        : void 0;
                },
                excel: function (t, e) {
                    return s.excelHtml5 && s.excelHtml5.available(t, e)
                        ? "excelHtml5"
                        : s.excelFlash && s.excelFlash.available(t, e)
                        ? "excelFlash"
                        : void 0;
                },
                pdf: function (t, e) {
                    return s.pdfHtml5 && s.pdfHtml5.available(t, e)
                        ? "pdfHtml5"
                        : s.pdfFlash && s.pdfFlash.available(t, e)
                        ? "pdfFlash"
                        : void 0;
                },
                    ...
                    function (t) {
                        if (t._buttons)
                            return d.buttonSelector(
                                d.instanceSelector(e, t._buttons),
                                n
                            );
                    },
                    !0
            ...
            m.Api.register("buttons.info()", function (t, e, n) {
                ...
                return (
                    !1 === t
                        ? (h("#datatables_buttons_info").fadeOut(function () {
                              h(this).remove();
                          }),
                          clearTimeout(o),
                          (o = null))
                        : (o && clearTimeout(o),
                          h("#datatables_buttons_info").length &&
                              h("#datatables_buttons_info").remove(),
                          h(
            ...
            m.Api.register("buttons.exportData()", function (t) {
                if (this.context.length) {
                    for (
                        var n = new m.Api(this.context[0]),
                            a = h.extend(
                                !0,
                                {},
                                {
                            ...
                            o =
                                ...
                                n.table().footer()
                                    ? n
                                          ...
                                          .toArray()
                                    : null),
                            r = n.rows(a.rows, a.modifier).indexes().toArray(),
                            l =
                                ((r = (l = n.cells(r, a.columns))
                                    .render(a.orthogonal)
                                    .toArray()),
                                l.nodes().toArray()),
                            i = t.length,
                        ...
                        for (var f = Array(i), p = 0; p < i; p++)
                            (f[p] = a.format.body(r[c], d, p, l[c])), c++;
                        u[d] = f;
                    }
                    return { header: t, footer: o, body: u };
                }
            }),
            m.Api.register("buttons.exportInfo()", function (t) {
                ...
                return (
                    ...
                    e === c || null === e
                        ? (e = null)
                        : (-1 !== e.indexOf("*") &&
                              (e = h.trim(e.replace("*", h("title").text()))),
                          (e = e.replace(
                              /[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g,
                              ""
                          )),
        ...
        var a = function (t) {
            ...
            l = function (t, e, n) {
                return null === (e = a(e))
                    ? null
                    : ((t = h("caption", t.table().container()).eq(0)),
                      "*" === e
                          ? t.css("caption-side") !== n
                              ? null
                              : t.length
                              ? t.text()
                              : ""
            ...
            b = h("<textarea/>")[0];
        return (
            (h.fn.dataTable.Buttons = d),
            (h.fn.DataTable.Buttons = d),
            h(r).on("init.dt plugin-init.dt", function (t, e) {
                if ("dt" === t.namespace) {
            ...
            m.ext.feature.push({
                fnInit: function (t) {
                    var e =
                        (t = new m.Api(t)).init().buttons || m.defaults.buttons;
            ...
            t.extend(e.ext.buttons, {
                ...
                columnVisibility: {
                    ...
                    action: function (t, e, n, a) {
                        (e = (t = e.columns(a.columns)).visible()),
                            t.visible(
                                a.visibility !== o
                                    ? a.visibility
                                    : !(e.length && e[0])
                            ...
                            .on(
                                ...
                                function (t, e) {
                                    !e.bDestroying &&
                                        ...
                                        r.active(a.column(o.columns).visible());
                                }
                            )
                            .on(
                                "column-reorder.dt" + o.namespace,
                                function (t, e, n) {
                                    1 === a.columns(o.columns).count() &&
                                        ("number" == typeof o.columns &&
                                            (o.columns = n.mapping[o.columns]),
                                        (t = a.column(o.columns)),
                                        r.text(o._columnText(a, o)),
                                        r.active(t.visible()));
                                }
                            ),
                ...
                colvisGroup: {
                    ...
                    action: function (t, e, n, a) {
                        e.columns(a.show).visible(!0, !1),
                            e.columns(a.hide).visible(!1, !1),
                            e.columns.adjust();
                    },
                    show: [],
                    hide: [],
    ...
    (function (o) {
        ...
        function S(t, e, n) {
            ...
            return (
                n &&
                    ...
                    null !== n.text &&
                        n.text !== v &&
                        a.appendChild(t.createTextNode(n.text))),
                a
            );
        }
        function I(t, e) {
        ...
        if (
            ...
            var u = s.document.createElementNS(
                ...
                m = function (t) {
                    setTimeout(function () {
                        "string" == typeof t
                            ? (s.URL || s.webkitURL || s).revokeObjectURL(t)
                            : t.remove();
                    }, 4e4);
                },
                w = function (t) {
                ...
                a = function (t, e, n) {
                    ...
                    if (((o.readyState = o.INIT), c))
                        (a = (s.URL || s.webkitURL || s).createObjectURL(t)),
                            setTimeout(function () {
                        ...
                        a ||
                            (a = (s.URL || s.webkitURL || s).createObjectURL(
                                t
                            )),
                            n
                                ? (s.location.href = a)
            ...
            T = function (t, e) {
                for (
                    var n = _(e),
                        ...
                        r = e.fieldSeparator,
                        l = RegExp(o, "g"),
                        i = e.escapeChar !== v ? e.escapeChar : "\\",
                        s = function (t) {
                            for (var e = "", n = 0, a = t.length; n < a; n++)
                                0 < n && (e += r),
                                    (e += o
                                        ? o + ("" + t[n]).replace(l, i + o) + o
                                        : t[n]);
                            return e;
                        },
                        u = e.header ? s(a.header) + n : "",
                        c = e.footer && a.footer ? n + s(a.footer) : "",
                        d = [],
                        f = 0,
                        p = a.body.length;
                    f < p;
                    ...
                    d.push(s(a.body[f]));
                return { str: u + d.join(n) + c, rows: d.length };
            },
            C = function () {
                if (
        ...
        return (
            (t.ext.buttons.copyHtml5 = {
                ...
                action: function (t, e, n, a) {
                    ...
                    if (
                        (r.title && (i = r.title + l + l + i),
                        r.messageTop && (i = r.messageTop + l + l + i),
                        r.messageBottom && (i = i + l + l + r.messageBottom),
                        a.customize && (i = a.customize(i, a)),
                        (a = b("<textarea readonly/>").val(i).appendTo(n)),
                        d.queryCommandSupported("copy"))
                    ) {
                        n.appendTo(e.table().container()),
                            a[0].focus(),
                            a[0].select();
                        try {
            ...
            (t.ext.buttons.csvHtml5 = {
                ...
                action: function (t, e, n, a) {
                    this.processing(!0),
                        (t = T(e, a).str),
                        (e = e.buttons.exportInfo(a)),
                        (n = a.charset),
                        a.customize && (t = a.customize(t, a)),
                        !1 !== n
                            ? (n || (n = d.characterSet || d.charset),
                              n && (n = ";charset=" + n))
                            : (n = ""),
                        a.bom && (t = "\ufeff" + t),
                        D(
                            new Blob([t], { type: "text/csv" + n }),
                            e.filename,
                            !0
                        ),
                        this.processing(!1);
            ...
            (t.ext.buttons.excelHtml5 = {
                ...
                available: function () {
                    return (
                        g.FileReader !== v && (y || g.JSZip) !== v && !C() && A
                    );
                },
                text: function (t) {
                ...
                action: function (t, e, n, a) {
                        ...
                        i =
                            ((t = {
                                ...
                                xl: {
                                    ...
                                    worksheets: { "sheet1.xml": d },
                                },
                                "[Content_Types].xml": t("[Content_Types].xml"),
                            }),
                            (n = e.buttons.exportData(a.exportOptions)),
                            function (t) {
                                u = S(d, "row", { attr: { r: (s = c + 1) } });
                                for (var e = 0, n = t.length; e < n; e++) {
                                    var a = x(e) + "" + s,
                                        o = null;
                                    if (
                    ...
                    b("sheets sheet", t.xl["workbook.xml"]).attr(
                        "name",
                        ((r = "Sheet1"),
                        (o = a).sheetName &&
                            (r = o.sheetName.replace(/[\[\]\*\/\\\?\:]/g, "")),
                        r)
                    ),
                        a.customizeData && a.customizeData(n);
                    var p = function (t, e) {
                            ...
                            n[0].appendChild(
                                ...
                                n.attr("count", n.attr("count") + 1),
                                b("row:eq(" + (t - 1) + ") c", d).attr(
                                    "s",
                                    "51"
                                );
                        },
                        h = e.buttons.exportInfo(a);
                    h.title && (i([h.title], c), p(c, n.header.length - 1)),
                        h.messageTop &&
                            (i([h.messageTop], c), p(c, n.header.length - 1)),
                        a.header &&
                            (i(n.header, c), b("row:last c", d).attr("s", "6"));
                    e = 0;
                    for (var m = n.body.length; e < m; e++) i(n.body[e], c);
                    for (
                        a.footer &&
                            n.footer &&
                            (i(n.footer, c), b("row:last c", d).attr("s", "6")),
                            h.messageBottom &&
                                (i([h.messageBottom], c),
                                p(c, n.header.length - 1)),
                            e = S(d, "cols"),
                            b("worksheet", d).prepend(e),
                            i = 0,
                            p = n.header.length;
                        i < p;
                        i++
                    ...
                    a.customize && a.customize(t),
                        ...
                        a.generateAsync
                            ? a.generateAsync(n).then(function (t) {
                                  D(t, h.filename), l.processing(!1);
                              })
                            : (D(a.generate(n), h.filename),
                              this.processing(!1));
                },
                filename: "*",
                extension: ".xlsx",
            ...
            (t.ext.buttons.pdfHtml5 = {
                ...
                action: function (t, e, n, a) {
                    ...
                    var o = this,
                        r =
                            ((t = e.buttons.exportData(a.exportOptions)),
                            e.buttons.exportInfo(a));
                    e = [];
                    a.header &&
                        e.push(
                            b.map(t.header, function (t) {
                                return {
                    ...
                    var l = 0;
                    for (n = t.body.length; l < n; l++)
                        e.push(
                            b.map(t.body[l], function (t) {
                                return {
                                    text: "string" == typeof t ? t : t + "",
                                    style:
                                        l % 2
                    ...
                    a.footer &&
                        ...
                        a.customize && a.customize(e, a),
                        (e = (i || g.pdfMake).createPdf(e)),
                        "open" !== a.download || C()
    ...
    (function (n) {
        ...
        return (
            (e.ext.buttons.print = {
                ...
                action: function (t, e, n, a) {
                    (t = e.buttons.exportData(
                        u.extend({ decodeEntities: !1 }, a.exportOptions)
                    )),
                        (n = e.buttons.exportInfo(a));
                    var o = function (t, e) {
                        for (var n = "<tr>", a = 0, o = t.length; a < o; a++)
                            n += "<" + e + ">" + t[a] + "</" + e + ">";
                        return n + "</tr>";
                    };
                    e = '<table class="' + e.table().node().className + '">';
                    a.header &&
                        (e += "<thead>" + o(t.header, "th") + "</thead>");
                    e += "<tbody>";
                    ...
                    (i.document.body.innerHTML =
                        ...
                        (n.messageBottom || "") +
                        "</div>"),
                        u(i.document.body).addClass("dt-print-view"),
                        u("img", i.document.body).each(function (t, e) {
                            e.setAttribute("src", d(e.getAttribute("src")));
                        }),
                        a.customize && a.customize(i),
                        setTimeout(function () {
