...
$(document).ready(function() {
    var options = {
        ...
        series: [{
            name: 'Encaissement ',
            data: [44, 55, 57, 56, 61, 58, 63, 60, 66,65,66,88]
        }, {
            name: 'Dépense',
            data: [76, 85, 101, 98, 87, 105, 91, 114, 94,75,77,99]
        }, {
            name: 'Recouvrement',
            data: [35, 41, 36, 26, 45, 48, 52, 53, 41,32,44,88]
        }],
        xaxis: {
            categories: ['Jav','Fév.', 'Mars', 'Avril', 'Mai', 'Juin', 'jui.', 'Août', 'Sept.', 'Oct.','Nov.','Déc.'],
        },
        yaxis: {
            title: {
                text: '(1000) XOF '
